...
public class UpdateCreditEntryHandlerTests
{
    ...
    public UpdateCreditEntryHandlerTests()
    {
        ...
        _handler = new UpdateCreditEntryHandler(_creditEntryRepositoryMock.Object, _unitOfWorkMock.Object);
    }
    ...
    public async Task Handle_ShouldReturnSuccess_WhenCreditEntryExists()
    {
        ...
        var command = new UpdateCreditEntryCommand(creditEntry.Id, true, paymentDate);
    ...
    {
        // Arrange
        var command = new UpdateCreditEntryCommand("nonexistent-id", true, DateTime.UtcNow);
    ...
    [Fact]
    public async Task Handle_ShouldUpdatePaymentStatus_ToUnpaid()
    {
        // Arrange
        ...
        var command = new UpdateCreditEntryCommand(creditEntry.Id, false, DateTime.UtcNow);
